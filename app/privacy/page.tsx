      ...
      <div className="max-w-5xl mx-auto px-4 py-16 relative">
        ...
        <div className="max-w-3xl mx-auto mb-16 text-center">
          <p className="text-lg text-muted-foreground/90 leading-relaxed mb-6">
            At NayaBharatYojana, we prioritize the protection of your privacy and personal information. This Privacy Policy outlines our practices for collecting, using, and safeguarding your data when you use our AI prompt management services.
          </p>
